    ...
    <>
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          <nav className="max-w-5xl mx-auto mb-6 text-sm text-slate-500" aria-label="Breadcrumb">
          ...
          <article className="max-w-5xl mx-auto">
            ...
            <h1 className="mb-4 text-4xl font-bold text-slate-900 md:text-5xl">{h1}</h1>
            <p className="mb-6 text-lg text-slate-600">{intro}</p>
            <p className="mb-10 text-sm text-slate-500">
              ZIP {zipCodes.join(", ")} · {city}, NV · Dr. Jan Duffy, License S.0197614.LLC
            </p>

            <section className="mb-12 rounded-2xl bg-slate-900 p-8 text-white">
              <h2 className="mb-6 text-center text-2xl font-bold">{name} snapshot</h2>
              ...
              <p className="mt-6 text-center text-xs text-slate-400">
                Figures are sourced where noted. Ask for a live CMA before pricing a bid. Last
                updated {lastUpdated}.
              </p>
            </section>
            ...
            <section className="mb-12">
              <h2 className="mb-4 text-2xl font-bold text-slate-900">Nearby pages</h2>
            ...
            <section className="rounded-2xl bg-blue-600 p-8 text-center text-white md:p-12">
              <h2 className="mb-3 text-3xl font-bold">Tour {name} with Dr. Jan Duffy</h2>
              <p className="mx-auto mb-6 max-w-2xl text-blue-100">
                First-party local guidance — not a syndicated listing dump. Call or text the client
                line.
              </p>
              <a
                href={CTA_TEL}
              ...
              <p className="mt-2 text-xs text-blue-200">
                {origin.replace("https://", "")} · Berkshire Hathaway HomeServices Nevada Properties
              </p>
            </section>
          </article>
        </div>
