          ...
          <section className="mb-16 max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                {
                  q: "Which areas have parks, trails, and nearby campuses?",
                  a: "Summerlin, Henderson (especially Green Valley and Inspirada), and Skye Canyon are compared on trail access, recreation centers, commute times, and named campuses. Dr. Jan sequences tours from those priorities—not a demographic filter.",
                },
                {
                ...
                {
                  q: "How do Henderson and Summerlin compare on amenities?",
                  a: "Henderson lists 60+ parks and multiple recreation centers. Summerlin is built around a trail network and Downtown Summerlin. Ask for a live CMA and a drive-time matrix for the streets you are considering—do not rely on a “safe neighborhood” slogan.",
                },
              ].map((faq, index) => (
