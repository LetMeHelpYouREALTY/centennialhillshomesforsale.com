          ...
          <section className="mb-16 max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-slate-700">
              ...
              <p>
                ...
                lifestyle to Henderson, Henderson — Nevada's second-largest
                city. Built by Del Webb from 1998-2008, this 7,100+ home
                community offers stunning mountain views, championship golf, and
