...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "What recreation does Skye Canyon include?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Skye Canyon includes Skye Center recreation, new CCSD campuses nearby, trail systems, and Floyd Lamb Park adjacency. Community events run at Skye Center through the year.",
      },
    },
    {
      "@type": "Question",
        ...
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                <h3 className="font-bold text-slate-900 mb-2">
                  What recreation does Skye Canyon include?
                </h3>
                <p className="text-slate-600">
                  Skye Canyon includes Skye Center recreation, nearby CCSD
                  campuses, trail systems, and Floyd Lamb Park adjacency. Events
                  run at Skye Center through the year.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                <h3 className="font-bold text-slate-900 mb-2">
