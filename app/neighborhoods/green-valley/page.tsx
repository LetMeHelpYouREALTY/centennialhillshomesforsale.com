...
export const metadata: Metadata = {
  ...
  description:
    "Find Green Valley homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy specializes in Henderson's most community with mature landscaping. Median price $520K. Call (702) 222-1964.",
  keywords: [
        ...
        <div className="container mx-auto px-4">
          ...
          <section className="text-center bg-blue-600 text-white rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-blue-100 mb-8">
              ...
              community with mature landscaping.
            </p>
            <a
