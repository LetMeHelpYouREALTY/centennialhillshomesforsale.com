    ...
    <TopicGuide
      ...
      sections={[
        ...
        },
        {
          ...
          body: "Call or text (702) 222-1964 or email homes@heyberkshire.com with the address, or use the form on this page. Occupied vs vacant vs tenant matters. Photos help if you are out of state.",
        },
        {
