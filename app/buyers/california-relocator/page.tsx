...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "California buyers typically gravitate toward Summerlin (similar to Irvine/coastal communities), Henderson (similar in layout to many San Diego suburbs), and The Ridges (comparable to Newport Coast luxury). These areas offer the quality and amenities California buyers expect.",
      },
    },
    {
      "@type": "Question",
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <p className="text-slate-600">
                  ...
                  (similar to Irvine/coastal communities), Henderson (similar in
                  layout to many San Diego suburbs), and The Ridges (comparable
                  to Newport Coast luxury). These areas offer the quality and
                  amenities California buyers expect.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                <h3 className="font-bold text-slate-900 mb-2">
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <p className="text-slate-600">
                  ...
                  Many California families choose areas with parks, trails, and
                  recreation centers or consider private options. Dr. Jan
                  provides school-specific guidance for every neighborhood.
                </p>
              </div>
            </div>
          </section>
